...
static struct ion_cp_heap_pdata cp_mm_ion_pdata = {
	...
	/* .fixed_position = FIXED_MIDDLE, - temporary remove for camera/music issues */
};
...
static struct ion_cp_heap_pdata cp_mfc_ion_pdata = {
	...
	.reusable = 0,
	.mem_is_fmem = FMEM_ENABLED,
	/* .fixed_position = FIXED_HIGH, - temporary remove for camera/music issues */
};
...
static struct ion_co_heap_pdata fw_co_ion_pdata = {
	...
	.align = SZ_128K,
	.mem_is_fmem = FMEM_ENABLED,
	/* .fixed_position = FIXED_LOW, - temporary remove for camera/music issues */
};
#endif
